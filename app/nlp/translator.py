...
class Translator:
    ...
    @staticmethod
    def translate(
        text: str, src_lang: str, tgt_lang: str, model, tokenizer, device, max_tokens
    ) -> str:

        try:
            pipeline = Translator.get_pipeline(
                src_lang, tgt_lang, model, tokenizer, device, max_tokens
            )
    ...
    @staticmethod
    def get_pipeline(
        src_lang: str, tgt_lang: str, model, tokenizer, device, max_tokens
    ):
        """
