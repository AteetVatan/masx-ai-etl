...
class TranslatorModelManager(AbstractModel[AutoModelForSeq2SeqLM]):
    ...
    def _load_model(self) -> AutoModelForSeq2SeqLM:
        ...
        try:
            ...
            self.logger.info(f"Loaded translation model '{self._model_name}' on {device}")
            return model
    ...
    def translate_text(self, text: str, source_lang: str, target_lang: str, instance: Optional[ModelInstance[AutoModelForSeq2SeqLM]] = None) -> str:
        """
    ...
    def _perform_translation(self, text: str, source_lang: str, target_lang: str, instance: ModelInstance[AutoModelForSeq2SeqLM]) -> str:
    ...
    def translate_to_english(self, text: str, source_lang: str, instance: Optional[ModelInstance[AutoModelForSeq2SeqLM]] = None) -> str:
        """
    ...
    def translate_from_english(self, text: str, target_lang: str, instance: Optional[ModelInstance[AutoModelForSeq2SeqLM]] = None) -> str:
        """
