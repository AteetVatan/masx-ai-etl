...
class LanguageDetectorTask:
    ...
    async def set_language_for_all_feeds(self, feeds: list[FeedModel]) -> list[FeedModel]:
        try:
            self.logger.info(
            ...
            self.logger.error(f"LanguageDetectorTask:Error setting language for feeds: {e}")
